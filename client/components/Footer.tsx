...
export default function Footer() {
  return (
    <footer className="flex flex-col md:flex-row justify-between items-center px-6 md:px-16 py-8 md:py-16 border-t border-black/15 gap-4 md:gap-0">
      ...
      <div className="flex-1 text-center md:text-left">
        <p className="text-xs md:text-2xl font-semibold leading-[120%] tracking-[-0.24px] md:tracking-[-0.48px]">
          <span className="text-black">inquiries </span>
          <span className="text-[#EEC55B]">@</span>
          <span className="text-black"> josiahdeleon.x@outlook.com</span>
        </p>
      </div>
